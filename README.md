...
Выберите в настройках модуля (вкладка Настройки) инфоблок в котором будет хранится контент сайта, при сохранении настроек свойство для хранения атрибутов создастся автоматически. Создайте список необходимых свойств через интерфейс редактирования в настройках (вкладка Атрибуты). Для свойства инфоблока с пользовательским типом "Rodzeta - Настраиваемые атрибуты" можно использовать максимум 30 разных атрибутов (ограничение bitrix при выводе множественного свойства). 
