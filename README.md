...
- выберите для заданного в настройках свойства инфоблока пользовательский тип "Rodzeta - Настраиваемые атрибуты", выставить максимальное число новых полей (30 - ограничение bitrix).
