...
Для свойства инфоблока с пользовательским типом "Rodzeta - Настраиваемые атрибуты" использовать максимум 30 разных атрибутов (ограничение bitrix при выводе множественного свойства). 
